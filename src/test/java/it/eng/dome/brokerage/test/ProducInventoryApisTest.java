...
public class ProducInventoryApisTest {
	...
	public static void main(String[] args) {
		 ...
		 * Update Product
		 */
//		String id = "urn:ngsi-ld:product:f7f7a097-d4ef-4805-8799-faf028c67323";
//		TestUpdateProduct(id);
	...
	protected static String TestCreateProduct() {
		...
		pc.setDescription("Simple product for testing");
		
		
		String id = apis.createProduct(pc);

		System.out.println("Product id: " + id);
		return id;
	}
	
	protected static boolean TestUpdateProduct(String id) {
		...
		pu.setName("Product 4 test");
		pu.setStatus(ProductStatusType.SUSPENDED);
		
		return apis.updateProduct(id, pu);
	}
}
